...
// constructor ------------------------------------------------------------------------------------------------
	private Assets() {
		...
		// default font
		font = new BitmapFont(Gdx.files.internal("res/font/PressStart2P.fnt"));
	...
	public static void initChars(ArrayList<GameChar> chars) {
		...
		if(initialised) {
			...
			for(GameChar c : chars) {
				...
				// magic sprites
				TextureAtlas mImgs = new TextureAtlas(
						"res/magic/sprites/" + c.getName() + ".pack");
